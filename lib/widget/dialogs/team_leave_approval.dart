...
class TeamLeaveApproval extends StatefulWidget {
  String arId;
  final Function() callback;

  TeamLeaveApproval({required this.arId, required this.callback});

  @override
  _TeamLeaveApprovalState createState() => _TeamLeaveApprovalState();
}

class _TeamLeaveApprovalState extends State<TeamLeaveApproval> {
  String sComment = "";
