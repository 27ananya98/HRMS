...
import '../dialogs/team_comp_off_approval.dart';
...
class TeamComp {
  ...
  static Widget teamCompOffPendingRequestCard(
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return TeamCompOffApproval(arId:sReqId,
                          callback: () {
                            refresh();
                          },
                        );
  ...
  static Widget teamCompOffHistoryRequestCard(
      BuildContext context,
      String sCreatedBy,
      String sReqId,
      String attendanceTypeName,
