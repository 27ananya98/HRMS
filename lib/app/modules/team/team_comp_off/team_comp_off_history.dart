...
class TeamCompOffHistory extends StatefulWidget {
  @override
  _ReoprtPageState createState() => _ReoprtPageState();
}

class _ReoprtPageState extends State<TeamCompOffHistory>
    with AutomaticKeepAliveClientMixin<TeamCompOffHistory> {
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                    ...
                                    child:
                                    TeamComp.teamCompOffHistoryRequestCard(
                                        context,
                                        createdByName,
                                        sRequestID,
                                        attendanceTypeName,
