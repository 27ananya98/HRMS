...
class TeamArPending extends StatefulWidget {
  @override
  _ReoprtPageState createState() => _ReoprtPageState();
}

class _ReoprtPageState extends State<TeamArPending>
    with AutomaticKeepAliveClientMixin<TeamArPending> {
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                    ...
                                    child:
                                        TeamArRequests.teamArPendingRequestCard(
                                            context,
                                            createdByName,
                                            sRequestID,
                                            attendanceTypeName,
