class MonthlyEmployeeLeaveReport {
  MonthlyEmployeeLeaveReport({
  ...
  MonthlyEmployeeLeaveReport.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['result'] != null) {
...
class Result {
  ...
  Result.fromJson(Map<String, dynamic> json) {
    pending =
        List.from(json['pending']).map((e) => Pending.fromJson(e)).toList();
