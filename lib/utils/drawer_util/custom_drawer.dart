...
class CustomDrawerController {
  CustomDrawerController({this.items = const [], required CustomDrawerContent initialPage}) {
...
class _KFDrawerState extends State<KFDrawer> with TickerProviderStateMixin {
  ...
  List<CustomDrawerItem> _getDrawerItems() {
    if (widget.controller?.items != null) {
      return widget.controller!.items.map((CustomDrawerItem item) {
...
class CustomDrawerItem extends StatelessWidget {
  ...
  CustomDrawerItem.initWithPage({this.onPressed, this.text, this.icon, this.alias, this.page});
